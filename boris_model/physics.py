...
единицы (Pch в Torr, L в см, dt в часах, R0/A1 в Torr·см²·ч/г). Температуры на
...
class Params:
    ...
    A1: float = 2.5              # наклон по l, на 1 см
...
def Rp_areal_si(l_m, p: Params):
    ...
    Линейно по толщине: (R0 + A1·l[см])·перевод (ТЗ 1.1)."""
    l_cm = l_m * 100.0
    return (p.R0 + p.A1 * l_cm) * RP_TO_SI
