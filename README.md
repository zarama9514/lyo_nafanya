...
$$T_s = T_p + \frac{1}{A_v}\,\frac{dQ}{dt}\left(\frac{1}{K_v} + \frac{l_{ice}}{k_1}\right)$$
...
$$J_s = \frac{P_{ice}(T_p) - P_c}{R_p(H)}, \qquad R_p(H) = f_{cryst}\left[\,R_{p0} + \frac{A_1\,H_{cm}}{1 + A_2\,H_{cm}}\,\right]$$
...
$$\eta(T) = \eta_g\cdot 10^{\,-\dfrac{C_1\,(T-T_g')}{\,C_2 + (T-T_g')\,}}, \qquad \eta_g \approx 10^{12}\ \mathrm{Pa\cdot s}$$
...
$$\ln P_{ice}\,[\mathrm{Pa}] = 9.550426 - \frac{5723.265}{T} + 3.53068\,\ln T - 0.00728332\,T, \qquad T\ [\mathrm{K}]$$
...
$$K_v = K_C + \frac{3.32\times10^{-3}\,P}{1 + K_D\,P}, \qquad P\ [\mathrm{Torr}]$$
